...
full-firmware-mem-protect: firmware bootloader-mem-protect ## Build full firmware (RDP level 2)
...
full-firmware: firmware bootloader ## Build full firmware (RDP level 0)
