...
class TestSkycoinCrypto(unittest.TestCase):
    def test_sign(self):
        ...
        ret, sig = skycoin.EcdsaSkycoinSign(seckey, digest)
        self.assertEqual(ret, 0)
        self.assertEqual(65, len(sig))
        ret, pubkey = skycoin.RecoverPubkeyFromSignature(digest, sig)
    ...
    def test_recover_pubkey_from_signed_digest(self):
        ...
        ret, pubkey = skycoin.RecoverPubkeyFromSignature(fingerprint, signature)
        self.assertEqual(ret, True)
        ...
        ret, _ = skycoin.RecoverPubkeyFromSignature(fingerprint, signature)
