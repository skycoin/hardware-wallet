...
START_TEST(test_deterministic_key_pair_iterator)
{
    ...
    strcpy(seed, "seed");
    deterministic_key_pair_iterator((const uint8_t*)seed, strlen(seed), next_seed, seckey, pubkey);
    ...
    memset(pubkey, 0, sizeof(pubkey));
    memset(seckey, 0, sizeof(seckey));
    deterministic_key_pair_iterator((const uint8_t*)seed, 32, next_seed, seckey, pubkey);
    ...
    memset(pubkey, 0, sizeof(pubkey));
    memset(seckey, 0, sizeof(seckey));
    deterministic_key_pair_iterator((const uint8_t*)seed, 64, next_seed, seckey, pubkey);
